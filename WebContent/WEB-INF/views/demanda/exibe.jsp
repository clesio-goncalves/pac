			...
			<div class="table-responsive">
				<table
					...
					<tr>
						...
						<td>${item.valor_total_estimado}</td>
					</tr>
			...
			<div class="table-responsive">
				<table
					...
					<tr>
						...
						<td>${item.estudo_preliminar.resultados_pretendidos}</td>
					</tr>

					<tr>
						<th>10. Providências para adequação do ambiente do órgão</th>
						<td>${item.estudo_preliminar.providencias_adequacao}</td>
					</tr>

					<tr>
						<th>11. Contratações correlatas e/ou interdependentes</th>
						<td>${item.estudo_preliminar.contratacoes_correlatas}</td>
					</tr>

					<tr>
						<th>12. Declaração da viabilidade ou não da contratação*</th>
						<td>${item.estudo_preliminar.declaracao_viabilidade}</td>
					</tr>
				</table>
			</div>
		</div>
